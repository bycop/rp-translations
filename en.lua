local my_language = {
	...
	available_restaurant = "Available restaurant",
	available_nightclub = "Available nightclub",
	restaurant_manager = "Restaurant manager",
	nightclub_manager = "Nightclub manager",
	make_restaurant_announcement = "Make restaurant announcement",
	make_nightclub_announcement = "Make nightclub announcement",
	leave_restaurant = "Leave restaurant",
	leave_nightclub = "Leave nightclub",
	you_left_restaurant = "~r~You left the restaurant.",
	you_left_nightclub = "~r~You left the nightclub.",
	claim_restaurant = "~b~claim restaurant~w~",
	claim_nightclub = "~b~claim nightclub~w~",
