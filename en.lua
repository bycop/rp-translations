local my_language = {
	...
	remaining_uses = "You have ~b~%s ~w~use(s) left.",
	...
	not_enough_of_x = "You do not have enough ~r~%s~w~.",
	...
	repair_veh_engine = "Repair engine",
	repair_veh_body = "Repair body",
	...
	warning_change_type_prod = "⚠️ You can change your production type only once a day.",
	shop_type = "Shop type",
	...
	delivered_to_pound_yard = "The ~b~%s~w~ has been delivered to the pound yard.",
	...
	must_threat_seller = "~r~You must threaten the seller with a weapon.",
	...
	modifications_saved_weapon = "~g~The changes to your weapon have been saved.",
	-- veh shop
	...
	target_no_family = "~r~The target does not have any family.",
	...
	race_join_game_x = "~b~join the race ~w~(Price ~g~$%s~w~)",
	...
	confirm_license_purchase = "Confirm purchase (type 'yes' to confirm)",
	...
	poke_hole_in_tyre = "poke a hole in the tyre",
	...
	not_enough_of_x_in_chest = "There is not enough ~r~%s~w~ in the trunk.",
	...
	hide_banks = "Hide banks",
	hide_rented_properties = "Hide rented properties",
	hide_owned_properties = "Hide owned properties",
	...
	you_created_new_group = "You created a new group/organization: ~g~%s",
	you_created_new_family = "You created a new family: ~g~%s",
	...
	tags_place_press = "Press ~INPUT_CONTEXT~ to tag here\n~INPUT_ARREST~ to toggle the editor.\n~INPUT_RELOAD~ to quit.",
	...
	no_family = "~r~You are not part of any family.",
	...
	set_sale_commission_x = "Your sale commission is ~g~$%s",
	fuel_tax = "Fuel tax",
	...
	delamain_failed = "Delamain couldn't make it, please call again.",
	...
	define_project_radius = "Define the radius of the project. The project will be loaded from this radius.",
	duplicate = "Duplicate",
	...
	burglary_menu = "Burglary Menu",
	not_in_interior = "~r~You are not in an interior.",
	no_entity_sets = "~r~You cannot manage this interior's entity sets.",
	interior_menu = "Interior Menu",
	set_theme_color = "Set theme color",
	edit_entity_sets = "Edit entity sets",
	restaurant = "Restaurant",
	max_item_crafting_x = "~r~You cannot craft more than %s items at the same time.",
	available_business = "Available business",
	business_manager = "Manager",
	leave_restaurant = "Leave the restaurant",
	make_announcement = "Make announcement",
	leave_job = "Leave job",
	you_left_job_place = "~r~You left the business place.",
	you_left_restaurant = "~r~You left the restaurant.",
	claim_restaurant = "~b~claim restaurant~w~",
	claim_job_place = "~b~claim the business~w~",
	...
	leave_job_place_control_too_far = "~r~You are too far from the business place. You will be kicked from the active employees.",
	...
	restaurant_desc = "Join this temporary job to claim any restaurant and serve foods & drinks to customers.",
	nightclub_desc = "Join this temporary job to claim any nightclub or bars to organize parties and serve drinks to customers.",
	unemployed_description = "This is the default job, which mean you are unemployed.",
	train_driver_description = "You are a train driver. You can drive trains and earn money.",
	tattoo_artist_description = "You are a tattoo artist. You can tattoo people and earn money.",
	hairdresser_description = "You are a hairdresser. You can cut people's hair and earn money.",
	pawnshop_description = "You are a pawnshop owner. You can buy and sell items and earn money.",
	taxi_description = "You are a taxi driver. You can drive taxi and earn money.",
	joined_lite_job_x = "You joined a temporary job: ~b~%s~w~.",
	left_lite_job_x = "You left a temporary job: ~b~%s~w~.",
	num_st = "%sst",
	num_nd = "%snd",
	num_rd = "%srd",
	num_th = "%sth",
	...
	reset = "Reset",
	firework_launcher = "Launcher",
	setup = "Setup",
	cooldown = "Cooldown",
	create_a_crew = "Create a crew",
	create_an_orga = "Create an organization",
	create_a_family = "Create a family",
	crew_name = "Crew name",
	organization_name = "Organization name",
	family_name = "Family name",
	chips_x = "Chips: ~g~%s~w~",
	casino_dollar_to_chip_x = "You converted ~g~$%s~w~ to ~g~%s chips~w~ for ~b~%s.",
	casino_chip_to_dollar_x = "You converted ~g~%s chips~w~ to ~g~$%s~w~ for ~b~%s.",
	open_chips_shop = "open chips shop",
	werewolf_game = "Werewolf Game",
	game_min_participants_x_start = "The game will start when there are at least %s participants.",
	game_max_participants_x_enter = "~r~The game will not accept more than %s participants.",
	game_starting_soon_find_place_seat = "The game will start soon. Find a good standing spot.",
	game_warning_leave = "~y~If you leave the area you will be kicked from the game.",
	game_starting_soon = "The game will start soon.",
	game_role_is_x = "Your role is: ~b~%s~w~.",
	game_village_go_sleep = "~b~The village is going to sleep.",
	game_village_wake_up = "~b~The village is waking up.",
	game_open_voting = "~b~The vote is starting, choose who you want to kill.",
	game_sleeping = "~b~(GAME) ~w~You are sleeping.",
	game_role_target_is_x = "The role of the target is: ~b~%s~w~.",
	game_set_lover_x_and_x = "The lovers are ~g~%s~w~ and ~g~%s~w~.",
	game_in_love_with_x = "You are in love with ~g~%s~w~.",
	game_x_voted_for_x = "~b~%s~w~ voted for ~g~%s~w~.",
	game_sorciere_already_used_x = "You already used your ~r~%s~w~ potion.",
	game_target_already_dead = "~r~The target is already dead.",
	game_target_not_dead = "~r~The target is not dead.",
	game_potion_kill = "death",
	game_potion_revive = "revive",
	game_player_x_killed_role_x = "~r~%s~w~ was killed and its role was ~r~%s~w~.",
	game_player_x_killed_role_x_lover = "~r~%s~w~ killed himself for love for ~r~%s~w~ and his role was ~r~%s~w~.",
	game_village_vote_elimated_x_with_x = "The village eliminated ~r~%s~w~ with ~r~%s~w~ votes.",
	game_your_turn_follow_instructions_wolf = "~b~(GAME) ~w~Press ~INPUT_CONTEXT~ to open the player menu.",
	game_remaining_time_x = "~b~(GAME) ~w~Remaining time: ~g~%s~w~.",
	validate_choices = "~g~Validate choices",
	game_need_x_targets = "You need to select ~r~%s~w~ targets.",
	game_instructions_cupidon = "~b~(CUPIDON)~w~ Select the two lovers.",
	game_instructions_voyante = "~b~(SEER)~w~ Select the player you want to know the role.",
	game_instructions_sorciere_victim_x = "~b~(WITCH) ~r~%s~w~ got killed. Select to revive, kill or do nothing.",
	game_instructions_loup = "~b~(WOLF)~w~ Select the player you want to kill.",
	game_instructions_vote = "~b~(VOTE)~w~ Select the player you want to eliminate.",
	select_potion = "Select potion",
	game_role = "Role",
	game_instruction_keys = "~INPUT_CONTEXT~ to join\n~INPUT_RELOAD~ to pickup",
	game_instruction_keys_in_game = "~INPUT_CONTEXT~ to leave\n~INPUT_RELOAD~ to pickup\n~INPUT_VEH_EXIT~ to start\n~INPUT_VEH_HEADLIGHT~ to play as spectator",
	game_werewolf = "Werewolf",
	game_player_x_joined = "~b~%s~w~ joined the game.",
	game_waiting_launch_game = "Waiting launch of the game.",
	loup = "Werewolf",
	voyante = "Seer",
	cupidon = "Cupid",
	sorciere = "Witch",
	...
	game_sorciere_potion_revive_x = "You have used your potion to revive ~g~%s~w~.",
	game_sorciere_potion_kill_x = "You have used your potion to kill ~r~%s~w~.",
	game_sorciere_do_noting = "~b~You have decided to do nothing.",
	game_villagers_won = "~b~The village won.",
	game_werewolves_won = "~b~The werewolves won.",
	game_tie = "~b~The game is a tie.",
	game_must_join_game = "~r~You must join the game to use this command.",
	game_spectator_mode_x = "~b~(GAME) ~w~The spectator mode is now %s~w~.",
	game_no_role_spectator_mode = "~r~You were not assigned a role as you're in spectator mode.",
	plush_01 = "Plush 01",
	plush_02 = "Plush 02",
	plush_03 = "Plush 03",
	plush_04 = "Plush 04",
	...
	unable_to_spawn_vehicle = "~r~Unable to spawn the vehicle.",
	preview_vehicle_instructions = "~INPUT_VEH_EXIT~ to exit\n~INPUT_VEH_RADIO_WHEEL~ to open the LS Custom",
	try_vehicle = "Try vehicle",
	premium = "Premium",
	premium_transfer_rules = "You can transfer a vehicle from one of ~b~your character~w~ to the one you're playing with.",
	my_premium_vehicle = "My premium vehicle",
	transfer_to_this_character = "Transfer to this character",
	premium_transfer_x_to_your_account = "You transfered your ~b~%s~w~ to your current character.\n~r~It will be in the pound yard next restart.",
	jewel_heist_success_run = "You successfully ran the jewel heist.\n~g~Reach the sell point to get your reward.",
	jewelery_heist_max_per_day = "~r~You can't run the jewel heist more than once per day.",
	bag_of_jewels = "Bag of jewels",
	lester_traded_x_for_x_money = "You delivered ~r~%s~w~ to Lester and received ~g~$%s~w~ as pay.",
	talk_to_lester = "~b~talk to Lester",
	deliver_jewels = "Deliver jewels",
	...
	door_groups_access_door = "These groups will be allowed to open the door.",
	open_door_list = "Open door list",
	...
	you_digged_x = "You digged ~b~%s~w~.",
	treasure_limit_reached = "~r~You reached the treasure limit for today.",
	...
	property_commission_too_high_x = "~r~Invalid invoice.~w~\nThe commission you set is above the cap of ~r~%s%%~w~.",
	weapon_max_ammo = "~r~You reached the maximum of ammo in your weapon.",
	invalid_tp_spot = "~r~Invalid teleport spot name.",
	refreshed_tp_spots = "~g~Refreshed teleport spots list.",
	bounds = "Bounds",
	remove_bound = "Remove bound",
	add_bound = "Add bound",
	property_bounds_incorrect = "~r~The bounds you set are incorrect, you need at least 4 points.",
	show_property_bounds = "Show property bounds",
	property_no_bounds_set = "~r~This property has no bounds set.",
	mapeditor_property_updated_to_x = "You have updated your project property id to ~g~%s~w~.",
	project_item_out_of_bound = "~r~You cannot enable this project, an item is outside the bounds (%s).",
	...
	chest_no_key = "~r~You don't have the key to this chest.",
	owner = "Owner",
	open_chest_list = "Open chest list",
	select_chest = "Select chest",
	chest_list = "Chest list",
	edit_chest = "Edit chest",
	register_chest = "Register chest",
	chest_edited = "~g~You edited the chest properly.",
	chest_placed = "~g~You placed the chest properly.",
	chest_already_exists = "~r~This chest already exists.",
	chest_deleted = "~r~You deleted the chest.",
	warning_delete_all_items = "~r~Warning, all items in the chest will be deleted.",
	chest_max_weight_x = "~r~You cannot put a chest with this weight.\n~r~Available weight: ~b~%s",
	...
	story = "Story",
	new_offer_help_camp = "I am new here, I would like to offer my help.",
	...
	already_own_yacht = "~r~You already own a yacht.",
	yacht_purchased_x = "You purchased a yacht for ~g~$%s~s~.",
	yacht_sold_x = "You sold your yacht for ~g~$%s~s~.",
	not_your_yacht_permission = "~r~You don't have permission to control this yacht.",
	yacht_already_called = "~r~Your yacht has already been deployed.",
	yacht_position_already_taken = "~r~This position is already taken by another yacht.",
	yacht_captain = "Yacht captain",
	customize_design = "Customize design",
	move_yacht = "Move yacht",
	sell_yacht = "Sell the yacht",
	yacht_improvement_already_purchased = "~r~You already purchased this yacht improvement.",
	yacht_improvement_purchased_x = "You purchased a yacht improvement ~b~'%s'~w~ for ~g~$%s~s~.",
	yacht_deployed_x = "You deployed your yacht to ~b~%s~s~.",
	yacht_sent_garage = "~r~You sent your yacht to the garage.",
	lockpick_broke = "~r~Your lockpick broke.",
	vehicle_get_in_before = "~r~Get in the vehicle before.",
	transaction = "Transaction",
	illegal = "Illegal",
	drop = "Drop",
	drop_in_vehicle = "drop in vehicle",
	drop_in_container = "drop in container",
	illegal_transaction_confirmed_x = "Illegal transaction of ~b~%sx %s~s~.",
	company_transaction_confirmed_x = "Company transaction of ~b~%sx %s~s~.",
	...
	holding_weapon_1 = "Holding weapon 1",
	holding_weapon_2 = "Holding weapon 2",
	holding_weapon_3 = "Holding weapon 3",
	holding_weapon_nvg_1 = "Holding weapon with NVG 1",
	holding_weapon_nvg_2 = "Holding weapon with NVG 2",
	hug_weapon_1 = "Hug weapon 1",
	hug_weapon_2 = "Hug weapon 2",
	pose_weapon_1 = "Pose weapon 1",
	pose_weapon_2 = "Pose weapon 2",
	pose_weapon_3 = "Pose weapon 3",
	aim_weapon = "Aim weapon",
	preaim_weapon = "Preaim weapon",
	run_weapon = "Run with weapon",
	tactical_kneel = "Tactical kneel",
	holding_vest_1 = "Holding vest 1",
	holding_vest_2 = "Holding vest 2",
	holding_side_vest = "Holding side vest",
	holding_siege_side_vest = "Holding siege side vest",
	holding_vest_siege_1 = "Holding vest siege 1",
	...
	weapon_throwable = "Weapon throwable",
	order_container = "Order container",
	orders = "Orders",
	basket_added_item_x = "You added ~b~%sx %s~s~ to your basket.",
	basket_removed_item = "You removed ~b~%s~s~ from your basket.",
	weapon_pickaxe = "Pickaxe",
	container_max_items_x = "A container can hold a maximum of ~b~%sx~s~ items.",
	basket_value = "Total value",
	basket_total_items = "Total items",
	order = "Order",
	order_items = "Order items",
	container_max_items_warn_x = "You cannot add more than ~b~%sx~s~ items to your basket.",
	container_max_weight_warn_x = "You cannot add more than ~b~%skg~s~ to your basket.",
	container_order_success_x_x = "You ordered a container of ~b~%sx items~s~ for ~g~$%s~s~.",
	container = "Container",
	trailer_attach = "Attach trailer",
	trailer_detach = "Detach trailer",
	create_trailer = "Create trailer",
	trailer_already_created = "~r~You already created a trailer.",
	carrying_x_item = "Carrying ~b~%sx %s~s~.",
	press_x_open_container_or_x_carry_or_x_delete = "%s to open container\n%s to carry the content.\n%s to delete the container.",
	container_empty = "~r~This container is empty.",
	container_not_empty = "~r~This container is not empty.",
	deliver_to_property = "deliver to this property",
	cannot_deliver_to_this_property = "~r~You cannot deliver to this property.",
	hydrogen = "Hydrogen",
	carbon = "Carbon",
	chloride = "Chloride",
	...
	interact_with_tank = "interact with fuel tank",
	...
	fuel_output_instructions_x = "~b~[%s]~w~ Oil available [~b~%sL]~w~\n%s to %s~w~ the closest valve.",
	cat_mirrors = "Mirrors",
	open_color = "~g~open",
	close_color = "~r~close",
	...
	prod_cow = "Cow (child)",
	prod_cow_grown = "Cow (grown)",
	prod_pig = "Pig (child)",
	prod_pig_grown = "Pig (grown)",
	prod_rabbit = "Rabbit (child)",
	prod_rabbit_grown = "Rabbit (grown)",
	prod_horse = "Horse (child)",
	prod_horse_grown = "Horse (grown)",
	prod_chicken = "Chicken (child)",
	prod_chicken_grown = "Chicken (grown)",
	prod_feeding_through = "Feeding through",
	...
	crate = "Crate",
	case_history_only_recent = "Only recent cases are displayed.",
	case_history = "Case history",
	gift_history_only_recent = "Only recent gifts are displayed.",
	gift_history = "Gift history",
	gift_x_to_x = "%sx %s to ~b~ID %s",
	refund = "Refund",
	refund_commerce_vehicle_help = "You can only refund vehicles you have twice.",
	...
	webhook_garage_description = "Send a webhook log when a player moves a vehicle from a garage.",
	property_webhook_storage_updated = "You updated the ~g~property~w~ storage webhook.",
	property_webhook_garage_updated = "You updated the ~g~property~w~ garage webhook.",
	...
	boygroup_pose_3 = "Boygroup pose 3",
	boygroup_pose_4 = "Boygroup pose 4",
	boygroup_pose_5 = "Boygroup pose 5",
	boygroup_pose_6 = "Boygroup pose 6",
	boygroup_pose_7 = "Boygroup pose 7",
	lean_wall_1 = "Lean wall 1",
	lean_wall_2 = "Lean wall 2",
	lean_wall_3 = "Lean wall 3",
	lean_wall_4 = "Lean wall 4",
	lean_wall_5 = "Lean wall 5",
	...
	deleted_scheme_map_project_x = "You deleted the scheme map project ~b~%s~w~ (%s).",
	deleted_quest_x = "You deleted the quest ~b~%s~w~ (%s).",
	edit_quest_x = "You edited the quest ~b~%s~w~ (%s).",
	created_quest_x = "You created the quest ~b~%s~w~ (%s).",
	quest_given_to_target_x = "You gave the quest ~b~%s~w~ to ~b~%s~w~.",
	quest_aborted_for_target_x = "You aborted the quest ~b~%s~w~ for ~b~%s~w~.",
	...
	quest_cat_default = "Default",
	quest_cat_illegal = "Illegal",
	quest_cat_police = "Police",
	give_quest_to_target = "Give quest to target",
	...
	quest_npc = "Quest NPC",
	quest_title_x = "Quest ~b~(%s)",
	quest_hud_always_display = "Always display quest HUD",
	search = "Search",
	...
	racket_instructions_aim_at_npc = "Aim the shop owner to start the racket.",
	racket_instructions_start = "~INPUT_CONTEXT~ to start the racket mission.",
	racket_instructions_owner = "~INPUT_CONTEXT~ to ask to retrieve your protection money.",
	racket_too_slow = "~r~Racket failed. You were too slow.",
	racket_started = "Intimidate the seller by breaking its shop.",
	racket_intimidation_finished = "~g~Intimidation succeeded.\n~w~Go outside to make sure no one is coming.",
	racket_already_started = "~r~A racket already started.",
	racket_cooldown_x = "You cannot start a racket. Wait ~r~%s~w~.",
	joined_attack_protection_event = "~r~You joined an attack protection event.",
	racket_fail_protection = "~r~You failed to survive the attack on the shop.\n~w~Capture failed.",
	...
	racket_shop_not_under_protection = "~r~This shop is not under your protection.",
	racket_shop_protection_cooldown_x = "Please wait at least ~r~%s~w~ before collecting the protection money.",
	racket_shop_protection_money_collected = "~b~You collected the protection money.~w~\nYou received ~g~$%s~w~.",
	smuggling = "Smuggling",
	fake_id = "Fake ID",
	...
	no_property_nearby2 = "None nearby",
	prostitute = "Prostitute",
	prostitute_place_street = "Place here in the street",
	prostitute_open_hotel_menu = "open the hotel menu",
	prostitute_send_to_hotel = "Send passengers to hotel",
	prostitutes = "Prostitutes",
	prostitute_work_night = "Prostitutes only work between ~r~%s:00~w~ and ~r~%s:00~w~.",
	prostitute_do_not_own = "~r~You do not own this prostitute.",
	prostitute_retrieved_shift_x_x = "~b~%s~w~ finished its shift of ~b~%s~w~.\nProfit: ~g~$%s",
	prostitute_started_shift = "~b~%s~w~ started its shift. Come back before ~r~%sh.",
	export_contract = "Export contract",
	export_contract_available = "Export contract available",
	export_contract_already_accepted_by_crew = "~r~This export contract is already accepted by your crew.",
	export_contract_accepted_x = "Export contract accepted.\n~g~%s",
	export_contract_created_x = "You created an export contract.\n~g~%s",
	export_contract_deleted_x = "You deleted an export contract.\n~g~%s",
	export_contract_updated_x = "You updated an export contract.\n~g~%s",
	export_contract_completed_x = "You completed an export contract.\n~g~%s",
	export_vehicle_wrong_spot = "~r~You are not at the correct export spot.",
	export_vehicle_wrong_type = "~r~You are not using the correct vehicle for the contract (%s).",
	export_deposit_vehicle_x = "You deposited ~g~x%s %s~w~ in the vehicle.\nContract: ~r~(%s/%s)",
	no_export_contract_accepted = "~r~You have no export contract accepted.",
	export_not_enough_items = "~r~You do not have enough items for the export contract.",
	export_contract_similar_items_already_accepted_by_crew = "~r~Your crew already accepted an export contract with similar items.",
	deliver_contract_cargo = "deliver the cargo to the export spot.",
	export_contract_deliver_location = "~b~Bring a transport vehicle on the marker and charge the cargo with a forklift.",
	export_contract_deliver_location_vehicle = "~b~Bring a transport vehicle ~r~(%s)~w~ on the marker and charge the cargo with a forklift.",
	export_contract_deliver_location2 = "Deliver the ~g~cargo~w~ to the location marked on your GPS.",
	export_contract_already_completed = "~r~This export contract was already completed by your crew.",
	export_instructions_place_vehicle = "Bring the relevant transport vehicle to this position and load the cargo.",
	export_fullfiled_item_objective = "You added the required amount of ~r~%s~w~ to the cargo.",
	export_not_enough_items_cargo = "~r~You need to add all the required items into the cargo before starting the mission.",
	export_mission_already_started = "~r~This export mission was already started by your crew.",
	export_contract_expired = "~r~This export contract expired.",
	export_deliver_before = "Time remaining",
	start_export_mission = "start the export mission",
	export_mission_failure_time = "~r~You failed the export mission because you did not deliver the cargo in time.",
	plane = "Plane",
	boat = "Boat",
}
