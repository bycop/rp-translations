local my_language = {
	...
	windows = "windows",
	doors = "doors",
	cruise_control = "Speed ​​regulator",
	...
	bank = "Bank",
	dashboard = "dashboard",
	anchor_dropped = "You have ~g~dropped~w~ the anshor!",
	lift_anchor = "You have ~r~lift~w~ the anshor!",
	vehicle_not_moving = "You must be at a standstill.",
	vehicle_moving_too_fast = "You are riving too fast to activate the cruise control.",
	surf_stored = "~g~you have stored your surf board.",
	...
	create_market_x = "You have placed a marker on ~g~%s~w~.",
	closed = "closed",
	opened = "open",
	door = "Door",
	...
	you_got_cuffed = "You have been ~r~menott~w~.",
	you_got_uncuffed = "You've been ~g~dementia~w~.",
	you_uncuffed_someone = "You have been ~g~demenotted~w~.",
	...
	lockpick_vehicle = "Lock the vehicle",
	...
	individual_calls_reinforcements = "Individual is calling for backup.",
	...
	removed_points_from_x = "You removed ~r~%s~w~ from his ~r~%s~w~.",
	...
	you_found_gold_nugget = "You have found ~y~%sg of gold~w~ in the ground.",
	ammo_box_opened = "You have opened your ~g~Ammunition Box~w~ and retrieved ~b~%s~w~ bullets from %s.",
	...
	vehicles_to_steal = "List of vehicles to fly",
	...
	water_for_surf = "~r~You have to be in the water to take your surf out",
	...
	animals_rules = "As an animal you must not:~r~~n- Speak~- Kill~n~r~- Steal",
	reached_use_limit_of_x = "You have reached the limit of use of: ~r~",
	door_lockpicked = "~g~You have locked the door.",
	flatbed_help_one = "Press ~INPUT_CONTEXT~ to ~y~lower ~w~the tray.",
	flatbed_help_two = "Press ~INPUT_CONTEXT~ to ~y~lower ~w~the tray.~n~Press ~INPUT_DETONATE~ to ~r~detach ~w~the vehicle.",
	flatbed_help_three = "Press ~INPUT_CONTEXT~ to ~y~remove ~w~the flatbed.~n~Press ~INPUT_DETONATE~ to ~g~attach ~w~a vehicle.",
	...
	conv_members_limit = "the conversation %s can't contain more than 20 members",
